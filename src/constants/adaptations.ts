...
export const ADAPTATIONS: AdaptationMeta[] = [
  ...
  },
  {
    ...
    // strength gap. See tekio.rfcs/grounding/039-adaptations-read.md#grounding
    repRange: [1, 5],
    /**
  ...
  },
  {
    ...
    // endurance at 15–30. See tekio.rfcs/grounding/039-adaptations-read.md#grounding
    repRange: [5, 30],
    /**
  ...
  },
  {
    ...
    // practitioner used three rounds or less than 1:1. See tekio.rfcs/grounding/039-adaptations-read.md#grounding
    rx: {
      load: 'All-out',
  ...
  },
  {
    ...
    // drives content (Granata 2018). See tekio.rfcs/grounding/039-adaptations-read.md#grounding
    rx: {
...
const KEYWORD_ADAPTATION: [string | RegExp, Adaptation][] = [
  ...
  // left. See tekio.rfcs/rfcs/done/0019-adaptation-model-simplification.md.
  ['sprint', 'power'],
  ['dash', 'power'],
  ['agility', 'power'],
  ['pogo', 'power'],
